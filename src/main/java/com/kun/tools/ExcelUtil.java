...
public class ExcelUtil {
     ...
     */
    public static <T> List<T> readExcel(String filePath, Class<T> clazz, Integer sheetNo) {
        ...
        return EasyExcel.read(filePath).head(clazz).sheet(sheetNo).doReadSync();
    }

    public static <T> List<T> readExcel(String filePath, Class<T> clazz) {
        return readExcel(filePath, clazz, 0);
    }
